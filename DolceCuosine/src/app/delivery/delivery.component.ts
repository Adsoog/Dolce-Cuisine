...
export class DeliveryComponent {
  ...
  data: any[] = [];
  nuevoDelivery: Delivery = {id: 0, nombre: "",comida: "", direccion: "", precio: 0, usuarioId: 0 };
  ...
  agregarDelivery() {
    this.apiService.guardarDelivery(this.nuevoDelivery).subscribe(deliveryAgregado => {
      console.log('Delivery agregado:', deliveryAgregado);
      this.llenarData();
      this.nuevoDelivery = {id: 0, nombre: "",comida: "", direccion: "", precio: 0, usuarioId: 0 };  // Limpiar los valores del formulario
    }, error => {
